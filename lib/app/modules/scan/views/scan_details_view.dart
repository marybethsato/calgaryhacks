...
class ScanDetailsView extends GetView<ScanController> {
  ...
  Taxon? get taxon {
    return controller.currentTaxon.value == null
        ? null
        : controller.currentTaxon.value!.results.isEmpty
            ? null
            : controller.currentTaxon.value?.results.first.taxon;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: taxon == null
          ? Center(
              child: Text(
              "Specie not identified. Try again later...",
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FutureBuilder<String?>(
                            future: INaturalistAPI.getWikipediaDescription(
                                title ?? ''),
                            builder: (context, snapshot) {
                              if (snapshot.connectionState ==
                                ...
                                return CircularProgressIndicator();
                                  ...
                                  snapshot.data == null) {
                                return Text(
                                    "No Wikipedia description available.");
                              }
                          ...
                          if (title != null)
                            FutureBuilder<ClimateChangeImpacts?>(
                              future: ClimateChangeImpactProvider
                                  .getClimateChangeImpact(title!),
                              builder: (context, snapshot) {
                                if (snapshot.connectionState ==
                                    ConnectionState.waiting) {
                                  return CircularProgressIndicator();
